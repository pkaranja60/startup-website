...
export const features = [
	{
		...
		description:
			"Optimized for 100 Lighthouse scores with sub-second load times",
	},
	{
		icon: Smartphone,
...
export const DatabaseServices = [
	{
		...
		desc: "Optimized schema and architecture",
	},
	{
		icon: Zap,
		title: "Performance Tuning",
		desc: "Query optimization and indexing",
	},
	{
		icon: Shield,
...
export const aiCapabilities = [
	{
		...
		desc: "Trained for your specific use case",
	},
	{
		icon: MessageSquare,
		title: "Chatbots",
	...
	},
	{
		icon: BarChart3,
		title: "Data Analytics",
		desc: "AI-powered insights from your data",
	},
