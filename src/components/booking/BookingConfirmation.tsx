...
import { CheckCircle2, Calendar as CalendarIcon, Clock, Video } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    >
                        <CheckCircle2 size={32} className="text-background lg:w-10 lg:h-10" strokeWidth={2.5} />
                    </motion.div>
                    ...
                    >
                        Your discovery call is scheduled. Check your inbox for the calendar invitation.
                    </motion.p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="text-left">
                                ...
                                <div className="flex items-center gap-3 font-semibold text-base lg:text-lg">
                                    ...
                                    <span className="wrap-break-words">{formatShortDate(selectedDate)}</span>
                                </div>
                            </div>
                            <div className="text-left">
                                <div className="text-xs font-bold uppercase tracking-widest text-text-tertiary mb-3">
