    ...
    >
      ...
      <div className="flex items-center justify-between mb-6 lg:mb-8 px-2">
        <button
          ...
          className={`p-2 rounded-xl transition-all duration-300 ${isCurrentMonth
        ...
        {monthDates.map((date) => {
          ...
          return (
            <motion.button
              ...
              className={`aspect-square p-2 lg:p-3 rounded-xl border transition-all duration-300 flex flex-col items-center justify-center gap-0.5 lg:gap-1 relative ${isSelected
